...
import time
# 打开数据库连接
db = pymysql.connect("localhost", "echo", "echo", "pydb", charset='utf8')
...
while m <= 1:
    ...
    url = 'http://sou.zhaopin.com/jobs/searchresult.ashx?jl=%E4%B8%8A%E6%B5%B7&kw=java%E5%BC%80%E5%8F%91%E5%B7%A5%E7%A8%8B%E5%B8%88&sm=0&isfilter=0&fl=538&isadv=0&sg=1737a59624184d6e9efa8849621b3216&p=3'
    # print('url is :' + url)
    m = m + 1
    # 抓取页码内容，返回响应对象
